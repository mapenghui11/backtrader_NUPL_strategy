    ...
    def next(self):
        ...
        if not self.position:
            ...
            if self.position.size > 0:
                close_bbands1_long = (self.close[0] > self.upper[0]) and (self.rsi[0] > 65)
...
if __name__ == '__main__':
    ...
    data_SOLUSDT = bt.feeds.PandasData(
        dataname=dataframe,
        fromdate=dt.datetime(2022, 5, 10),
        todate=dt.datetime(2022, 6, 14),
